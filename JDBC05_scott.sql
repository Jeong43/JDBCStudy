...
--○ 실습 테이블 생성
-- 사번  이름  주민번호  입사일  지역  전화번호  부서  직위  기본급  수당  급여(※계산하여 표기)
...
--○ 전체 직원 정보 
SELECT E.EMP_ID, E.EMP_NAME, E.SSN, E.IBSADATE, C.CITY_NAME, E.TEL, B.BUSEO_NAME, J.JIKWI_NAME, E.BASICPAY, NVL(E.SUDANG, 0), (E.BASICPAY + NVL(E.SUDANG, 0))
...
-- 급여 내림차순
SELECT E.EMP_ID, E.EMP_NAME, E.SSN, E.IBSADATE, C.CITY_NAME, E.TEL, B.BUSEO_NAME, J.JIKWI_NAME, E.BASICPAY, NVL(E.SUDANG, 0), (E.BASICPAY + NVL(E.SUDANG, 0)) FROM TBL_EMP E LEFT JOIN TBL_CITY C ON E.CITY_ID = C.CITY_ID LEFT JOIN TBL_BUSEO B ON E.BUSEO_ID = B.BUSEO_ID LEFT JOIN TBL_JIKWI J ON E.JIKWI_ID = J.JIKWI_ID
 ORDER BY 11 DESC
;
...
-- 이름
SELECT E.EMP_ID, E.EMP_NAME, E.SSN, E.IBSADATE, C.CITY_NAME, E.TEL, B.BUSEO_NAME, J.JIKWI_NAME, E.BASICPAY, NVL(E.SUDANG, 0), (E.BASICPAY + NVL(E.SUDANG, 0)) FROM TBL_EMP E LEFT JOIN TBL_CITY C ON E.CITY_ID = C.CITY_ID LEFT JOIN TBL_BUSEO B ON E.BUSEO_ID = B.BUSEO_ID LEFT JOIN TBL_JIKWI J ON E.JIKWI_ID = J.JIKWI_ID
 WHERE E.EMP_NAME = '홍빵빵'
;


--○ 회원정보 수정
UPDATE TBL_EMP
SET EMP_NAME='홍빵빵', SSN='771212-1022432', IBSADATE='1998-10-12', CITY_ID=5, TEL='011-4444-4444'
  , BUSEO_ID=2, JIKWI_ID=8, BASICPAY=1000000, SUDANG=112000
WHERE EMP_ID = 1001;

--> 한줄
UPDATE TBL_EMP SET EMP_NAME='홍빵빵', SSN='771212-1022432', IBSADATE='1998-10-12', CITY_ID=5, TEL='011-4444-4444', BUSEO_ID=2, JIKWI_ID=8, BASICPAY=1000000, SUDANG=112000 WHERE EMP_ID = 1001
;
...
--○ 직위 기본급 조회
SELECT MIN_BASICPAY FROM TBL_JIKWI WHERE JIKWI_ID = 1
;
...
--○ 직위 명단
SELECT JIKWI_NAME FROM TBL_JIKWI ORDER BY JIKWI_ID
;
...
--○ 부서 명단 출력
SELECT BUSEO_NAME FROM TBL_BUSEO ORDER BY BUSEO_ID
;
...
SELECT BUSEO_ID FROM TBL_BUSEO WHERE BUSEO_NAME = '인사부'
;
...
SELECT BUSEO_NAME FROM TBL_BUSEO WHERE BUSEO_ID = 1
;

SELECT JIKWI_NAME FROM TBL_JIKWI WHERE JIKWI_ID = 1
;
...
-- 5. 데이터(직원 정보) 입력 쿼리문
INSERT INTO TBL_EMP (EMP_ID, EMP_NAME, SSN, IBSADATE, CITY_ID, TEL, BUSEO_ID, JIKWI_ID, BASICPAY, SUDANG) 
VALUES (EMPSEQ.NEXTVAL, '정미화', '940403-2234567', TO_DATE('2001-10-10', 'YYYY-MM-DD')
        , (SELECT CITY_ID FROM TBL_CITY WHERE CITY_NAME='서울')
        , '010-8743-7042'
...
1061	김진희	940403-2037910	2019-07-02	서울	010-8743-1111	개발부	사원	2000000	300000	2300000
1062	    정미화	940403-2234567	2001-10-10	서울	010-8743-7042	개발부	대리	2200000	2000000	4200000
*/
...
SELECT EMP_ID, EMP_NAME, SSN, TO_CHAR(IBSADATE, 'YYYY-MM-DD') AS IBSADATE, CITY_NAME, NVL(TEL, '-') AS TEL, BUSEO_NAME, JIKWI_NAME, BASICPAY, SUDANG, PAY FROM EMPVIEW ORDER BY EMP_ID
;
...
-- 10. 직원 데이터 수정 쿼리문
UPDATE TBL_EMP
SET EMP_NAME = '이찬호', SSN = '941108-2222222'
  , IBSADATE = TO_DATE('2021-01-22', 'YYYY-MM-DD')
...
--> 한 줄 구성
UPDATE TBL_EMP SET EMP_NAME = '이찬호', SSN = '941108-2222222', IBSADATE = TO_DATE('2021-01-22', 'YYYY-MM-DD'), CITY_ID = (SELECT CITY_ID FROM TBL_CITY WHERE CITY_NAME='제주'), TEL = '010-3370-5057', BUSEO_ID = (SELECT BUSEO_ID FROM TBL_BUSEO WHERE BUSEO_NAME='개발부'), JIKWI_ID = (SELECT JIKWI_ID FROM TBL_JIKWI WHERE JIKWI_NAME='과장'), BASICPAY = 3000000, SUDANG = 200000 WHERE EMP_ID=1061
;
